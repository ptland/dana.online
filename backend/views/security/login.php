...
<html lang="en">
    ...
    <head>
        ...
        <title>Online Shopping System Admin Panel</title>
                            ...
                            <div id="login" class="show">
                                ...
                                <form action="index.php" method="post">
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type="email" class="form-control" name="email" id="email" placeholder="example@hotmail.com" autofocus required="">
